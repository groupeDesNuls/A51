...
public class WrkManette extends Thread
{
  ...
  private boolean connected = false;
    ...
    public void run() {
        ...
        while (true) {
            ...
            poll();
            currentValue = getXYStickDir();
            if (currentValue != previousValue || isButtonPressed(9)) {
            if(isButtonPressed(9)){
                wrk.klaxonne();
            }else if(currentValue == WrkManette.NORTH){
                    wrk.avance("10");
                }else if(currentValue == WrkManette.SOUTH){
                    wrk.recule("10");
                }else if(currentValue== WrkManette.EAST){
                    wrk.tourne(false);
                }
                else if(currentValue == WrkManette.WEST){
                    wrk.tourne(true);
                }else if(currentValue == 4){
                    wrk.stopRobot();
                }else if(currentValue == WrkManette.NE){
                    wrk.tourneEnMarche(false);
                }else if(currentValue == WrkManette.NW){
                    wrk.tourneEnMarche(true);
                }
